...
st.markdown("""
    ...
    <div class="project-details">
        <h3>👨‍💻 Group Project: Cybersecurity Vulnerability Predictor</h3>
        <p class="supervision-text">Under the supervision of Dr. Gaurav Sir</p>
        <div class="name-group">
            <span>Pradeep Dubey</span>
            <span>Aman Kumar</span>
            <span>Apoorva Kakkar</span>
            <span>Anshi Gupta</span>
        </div>
    </div>
""", unsafe_allow_html=True)
